...
void proxypack() {
    std::string proxy;
    proxy =
        "\nadd_label_with_icon|big|`#AShit skidder Proxy `9Gazette|left|7188|"
        "\nadd_textbox|`cYou are using AJProxy's Version: V2.2|left|2480|"
...
bool events::in::variantlist(gameupdatepacket_t* packet) {
    ...
    case fnv32("OnConsoleMessage"): {
        ...
        varlist[1] = "`9[`5FinHek#0582 on top niggas```9]`` " + varlist[1].get_string();
        if (spam) {
